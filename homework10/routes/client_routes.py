...
@client_router.get('/get-all', response_model=list[ClientOut], operation_id='client_get_all')
...
@client_router.get('/get/{client_id}', response_model=ClientOut, operation_id='client_get_by_id')
...
@client_router.post('/create', response_model=ClientOut, operation_id='client_create')
...
@client_router.delete('/delete/{client_id}', operation_id='client_delete')
...
@client_router.put('/update', response_model=ClientOut, operation_id='client_update')
async def update(update_client_data: ClientUpdate,
                 client_repository: ABCClientRepository = Depends(get_client_repository)):
